...
test_loader = get_dataset_loader(args.Dataset, args)[1]
...
# Train the model
train_miou, test_miou, train_acc, test_acc, train_accuracy, test_accuracy, train_loss, test_loss = get_test(args.model, model, test_loader, args)
